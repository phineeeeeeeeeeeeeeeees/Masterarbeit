...
# Masterarbeit
# Modeling
# Annual model: Light gradient boosting machine (LightGBM)-- grid search of hyperparameters
# 2021-08-23
#####################################################################################################
...
clusterExport(
  cl = cl , 
  varlist = c("data_annual" , "CV_folds" , "included_var" , "response_full" , "columns_nonpredictor")
)
# random seed
...
# =====================================
out_dirpath_hypergrid <- "3_results/output-data/model_annual/LGB_grid-search"
