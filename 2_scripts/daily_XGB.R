...
# =====================================
hyper_grid <- read_csv("3_results/output-data/model_daily/XGB_grid-search/hyper_evaluation_full.csv")
...
# =====================================
xgb_final_prediction <- data_daily %>% 
...
# This is synonymous with XGB’s relative.influence
...
xgb_final_importance %>% 
  ...
  labs(x = "Variables" , y = "Gain" , 
       title = sprintf("XGBoost variable importance (with %s)" , SAT_product) , 
...
# =====================================
moran_day_df <- eval_resid_moran(xgb_final_prediction , by_time = TRUE , col_time = "date")
