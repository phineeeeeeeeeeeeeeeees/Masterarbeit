...
# Masterarbeit
# Modeling
# Daily model: Light gradient boosting machines 
# 2021-08-22
#####################################################################################################
...
# =====================================
hyper_grid <- read_csv("3_results/output-data/model_daily/LGB_grid-search/hyper_evaluation.csv")
...
# =====================================
lgb_final_prediction <- data_daily %>% 
...
# =====================================
moran_day_df <- eval_resid_moran(lgb_final_prediction , by_time = TRUE , col_time = "date")
